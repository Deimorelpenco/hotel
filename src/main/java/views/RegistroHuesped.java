...
public class RegistroHuesped extends JFrame {
	...
	public void registroHuesped(Reserva reserva) {
		String fechaN = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		
		Huesped nuevoHuesped = new Huesped(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), reserva);	
				
						
		EntityManager em = JPAUtil.getEntityManager();
		HuestedDao huespedDao = new HuestedDao(em);
