...
public class ReservasView extends JFrame {
	...
	public ReservasView() {			
		...
		lblFormaPago.setBounds(68, 382, 260, 24);
		lblFormaPago.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblFormaPago);
		
		JLabel lblTitulo = new JLabel("SISTEMA DE RESERVAS");
		lblTitulo.setBounds(94, 60, 247, 42);
	...
	protected void calcularValor(JDateChooser txtFechaEntrada2, JDateChooser txtFechaSalida2) {
		...
		if (txtFechaEntrada.getDate().after(txtFechaSalida.getDate())) {
			JOptionPane.showMessageDialog(null, "La fevha de salida debe ser posterior a la fechade entrada", "Error en las fechas" , JOptionPane.ERROR_MESSAGE);
			txtFechaEntrada2.setDate(null);
			txtFechaSalida2.setDate(null);
			txtValor.setText(null);
			return;
		}else {
			Calendar inicio = txtFechaEntrada2.getCalendar();
			Calendar fin = txtFechaSalida2.getCalendar();
			int dias = -1;
			int precio = 500;
			Integer valor;
